<div class='p-6'>
    @if (session('success'))
        <div id="" class="flex items-center w-full p-4 my-2 text-gray-500 bg-green-500 rounded-lg shadow "
            role="alert">
            <div
            ...
            <div class="ml-3 text-sm font-normal text-green-50">{{ session('success') }}</div>
        </div>
    @endif
